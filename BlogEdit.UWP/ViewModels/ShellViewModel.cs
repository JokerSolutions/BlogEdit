...
namespace BlogEdit.UWP.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_Pages".GetLocalized(), Symbol.Document, typeof(PagesViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_Posts".GetLocalized(), Symbol.Document, typeof(PostsViewModel).FullName));
